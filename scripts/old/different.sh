...
DATASET_BASE="/shared/sets/datasets/PALATE_FIG_6_DIFFERENT_CLASSES"

MODELS=("StyleGAN-XL" "PFGMPP" "MHGAN" "StyleGAN2-ada" "BigGAN-Deep")
MODELS=("StyleGAN2-ada")
SUBSETS=("1_classes" "2_classes" "3_classes" "4_classes" "5_classes" \
         "6_classes" "7_classes" "8_classes" "9_classes" "10_classes")

SUBSETS=("6_classes" "7_classes" "8_classes" "9_classes" "10_classes")
...
for model in "${MODELS[@]}"; do
    ...
    for metric in "${METRICS[@]}"; do
        OUTPUT_BASE="$HOME/dgm-eval/new_cls_id_different_classes_$metric"
